...
class NodeTests: FRAuthBaseTest {
    ...
    func testNodeRequestPayloadWithPageHeaderAndDescription() {
        // Given
        let jsonStr = """
        {
            "authId": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..oEiBLxT62uwmz0EtLQxwzjyrgcIy7fpevO6TntEK8aM",
        ...
        do {
            ...
            let payload = node?.buildRequestPayload()
            
            XCTAssertNotNil(payload)
            XCTAssertEqual(payload?["header"] as? String, "This is header")
            XCTAssertEqual(payload?["description"] as? String, "This is description")
            XCTAssertEqual(payload?["stage"] as? String, "This is stage")
        } catch {
            XCTFail("Failed with unexpected error: \(error)")
        }
    }
