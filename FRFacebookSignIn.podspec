#
# Be sure to run `pod lib lint FRFacebookSignIn.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.ios.dependency 'FRAuth', '~> 4.4.1-beta1'
  s.ios.dependency 'FBSDKLoginKit', '~> 17.0.0'
end
