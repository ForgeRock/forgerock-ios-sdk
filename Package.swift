...
let package = Package (
    ...
    dependencies: [
        ...
        .package(name: "SwiftProtobuf", url: "https://github.com/apple/swift-protobuf.git", .exact("1.24.0"))
    ],
    targets: [
        ...
        .target(name: "FRAuthenticator", dependencies: [.target(name: "FRCore"), .target(name: "cFRAuthenticator"), .product(name: "SwiftProtobuf", package: "SwiftProtobuf")], path: "FRAuthenticator/FRAuthenticator", exclude: ["Info.plist", "FRAuthenticator.h", "SharedC/Sources/include/base32.h", "SharedC/Sources/base32.c", "SharedC/FRAuthenticator.modulemap"]),
