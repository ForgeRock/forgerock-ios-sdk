...
let package = Package (
    ...
    dependencies: [
        ...
        .package(name: "GoogleSignIn", url: "https://github.com/google/GoogleSignIn-iOS.git", .upToNextMinor(from: "9.0.0")),
        .package(name: "JOSESwift", url: "https://github.com/airsidemobile/JOSESwift.git", .exact("3.0.0")),
        .package(name: "PingOneSignals", url: "https://github.com/pingidentity/pingone-signals-sdk-ios.git", .upToNextMinor(from: "5.3.0")),
        .package(name: "RecaptchaEnterprise", url: "https://github.com/GoogleCloudPlatform/recaptcha-enterprise-mobile-sdk.git", .upToNextMinor(from: "18.9.1"))
    ],
    targets: [
        ...
        .target(name: "FRUI", dependencies: [.target(name: "FRDeviceBinding"), .target(name: "FRCaptchaEnterprise")], path: "FRUI/FRUI", exclude: ["Info.plist", "FRUI.h"], resources: [.copy("PrivacyInfo.xcprivacy")]),
